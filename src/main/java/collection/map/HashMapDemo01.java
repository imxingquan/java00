...
public class HashMapDemo01 {
    ...
    public void test_compute(){
        ...
        double newValue =  map.compute("钢铁是怎样练成的",(k,v)->{return v * 0.9;});
    ...
    public void test_computeIfAbsent(){
        ...
        double newValue =  map.computeIfAbsent("钢铁是怎样练成的",key->{return 9.0;});
        ...
        newValue =  map.computeIfAbsent("钢铁是怎样练成的",key->{return 9.0;});
    ...
    public void test_computeIfPresent(){
        ...
        double newValue =  map.computeIfPresent("钢铁是怎样练成的",(k,v)->{return 9.0;});
        Assert.assertEquals(9.0,map.get("钢铁是怎样练成的"),1);

        //新的value为null从map中删除key-value对
        map.computeIfPresent("钢铁是怎样练成的",(k,v)->{return null;});
        Assert.assertEquals(1,map.size());
